...
hist_df = pd.read_csv('D:/currency exchange rate forecasting/hkd_data_2010_inr.csv')   
...
df.to_csv('D:/currency exchange rate forecasting/hkd_data_2010_inr.csv')


inr_df = df[df['Currency'] == 'INR']
# Print column names to verify their existence
print(inr_df.columns)
